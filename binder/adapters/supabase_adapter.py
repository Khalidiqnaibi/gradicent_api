...
class SupabaseAdapter(StorageAdapter):
    def __init__(self,url: str = "", key: str = ""):
        ...
        self.table_map = {
            "users": os.getenv("DB_TABLE_USERS", "sys_accounts_v1"),
            "clients": os.getenv("DB_TABLE_CLIENTS", "crm_entities_v1"),
            "employees": os.getenv("DB_TABLE_EMPLOYEES", "hr_entities_v1"),
            "products": os.getenv("DB_TABLE_PRODUCTS", "inv_items_v1"),
            "services": os.getenv("DB_TABLE_SERVICES", "svc_catalog_v1"),
