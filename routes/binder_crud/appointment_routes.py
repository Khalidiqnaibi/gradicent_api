...
def get_appointments_for_date(date):
    ...
    return make_response(data={"appointments": result}, code=200)
...
def save_appointments_for_date(date):
    ...
    return make_response(message="Appointments saved successfully", code=200)
...
def lock_appointments():
    ...
    return make_response(message="Appointment locked.", code=200)
